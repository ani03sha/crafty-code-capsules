...
export default function Project({
    ...
    return (
        <motion.div
            ...
            >
            <section
                className="bg--gray-100 max-w-[42rem] border border-black/10 overflow-hidden sm:pr-8 sm:h-[20rem] hover:bg-gray-200 
                        group-even:pl-8 rounded-lg transition relative">
